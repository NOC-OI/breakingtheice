  ...
  return (
    ...
    >
      <div className="relative mx-1 h-full w-[76vw] px-4 pb-8 pt-14 xl:pt-35 xl:mx-auto xl:w-[min(1440px,96vw)] sm:px-8 lg:px-18">
        ...
        <div
          className={`mt-5 flex w-full flex-row gap-104 ${questionIndex === 0 && 'ml-120'} md:w-40 xl:mt-8 xl:flex-col xl:gap-3 xl:ml-150`}
        >
          {questionIndex > 0 && (
            <button
              type="button"
          ...
          <button
            ...
            onClick={onNext}
            disabled={!isCorrect}
            className="inline-flex h-11 w-29.25 items-center justify-center gap-2 rounded-sm bg-[#0d3352] px-6 text-[16px] font-semibold text-white transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-50"
          >
            <span>Next</span>
