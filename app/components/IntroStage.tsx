...
export function IntroStage({
  ...
  return (
    <section className="relative z-20 h-full w-full overflow-hidden bg-[#b9b3b9]">
      ...
      <div className="absolute right-[1vw] xl:right-[10vw] z-10 top-0 drop-shadow-[0_18px_24px_rgba(0,0,0,0.35)] animate-[fadeIn_.45s_ease-out]">
        <Image
      ...
      {showStartMission && (
        <div className="absolute left-[max(24px,7vw)] xl:top-[26vh] z-20 w-[51%] xl:w-[55%] xl:w-[min(92vw,1100px)] text-black">
